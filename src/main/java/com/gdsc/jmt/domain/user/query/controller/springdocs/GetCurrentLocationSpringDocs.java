...
import com.gdsc.jmt.global.controller.springdocs.LocationNotFoundException;
...
@Operation(summary = "사용자 주소 반환 API", description = "현재 로그인 되어있는 사용자의 정보를 조회합니다.")
@ApiResponses(value = {
        @ApiResponse(responseCode = "200", useReturnTypeSchema = true),
        @ApiResponse(
                responseCode = "404",
                description = "위치 정보를 찾을 수 없습니다.",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = LocationNotFoundException.class))
        ),
        @ApiResponse(
                responseCode = "500",
...
public @interface GetCurrentLocationSpringDocs {
}
